        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div>
            ...
            <p className="text-lg text-slate-200 mb-8 leading-relaxed max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200 font-light">
              Solusi logistik terpercaya untuk pengiriman cepat, aman, dan terjangkau hingga ke daerah terpencil yang sulit diakses.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
              <a href="#services" className="px-8 py-4 bg-secondary-500 hover:bg-secondary-600 text-white rounded-xl font-bold flex items-center justify-center gap-2 transition-all hover:-translate-y-1 shadow-lg shadow-secondary-500/25">
                Lihat Layanan
                <ArrowRight className="w-5 h-5" />
              </a>
              <a href="#contact" className="px-8 py-4 bg-white hover:bg-slate-50 text-slate-900 rounded-xl font-bold transition-all hover:-translate-y-1 shadow-lg">
                Hubungi Kami
              </a>
            </div>
          </div>
