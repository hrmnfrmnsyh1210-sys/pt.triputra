  ...
  return (
    <section id="about" className="py-24 bg-slate-50">
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start mb-20">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6 tracking-tight">
              Ekspedisi{" "}
              <span className="text-primary-600">Kalimantan Barat</span>{" "}
              Terpercaya
            </h2>
        ...
        <div
          id="vision"
          className="grid lg:grid-cols-12 gap-12 bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-slate-100 relative overflow-hidden"
        >
          {/* Decor */}
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-slate-600 leading-relaxed italic">"{VISION}"</p>
          </div>
